<script>
	...
	function calculatePower() {
		...
		// Define thermal constants with sensible defaults
		const ambientTemp = typeof settings.advancedSettings?.ambientTemp === 'number' ? settings.advancedSettings.ambientTemp : 25; // °C
		const thermalResistance = typeof settings.advancedSettings?.thermalResistance === 'number' ? settings.advancedSettings.thermalResistance : 50; // °C/W
...
<div class="led-strip-config">
	...
	<div class="config-section">
		...
		<SettingsFormField
			...
			on:change={(e) => handleConfigChange('ledType', e.detail.value)}
		/>
	...
	<div class="config-section">
		<SettingsFormField
			...
			on:change={(e) => handleConfigChange('ledCount', e.detail.value)}
		/>
	</div>
	...
	<div class="config-section">
		...
		<div class="config-row">
			<SettingsFormField
				...
				on:change={(e) => handleConfigChange('ledOrientation', e.detail.value)}
			/>
			<span class="input-hint">Tip: Set to "Reversed" if the first lit LED appears at the end of the strip.</span>
		</div>

		<div class="config-row brightness-control">
			<SettingsFormField
				type="range"
				label="Brightness"
				id="brightness"
				...
				on:input={(e) => handleInput('brightness', e.detail.value)}
				on:change={(e) => handleConfigChange('brightness', e.detail.value)}
			/>
			<div class="brightness-readout">{Math.round(Number(settings.brightness) || 0)}%</div>
		</div>
		<!-- Removed advanced brightness-related settings for now -->
		</div>
	...
	<div class="config-section">
		...
		<SettingsFormField
			...
			{disabled}
			category="led"
			settingKey="power_supply_voltage"
			...
			on:input={(e) => handleInput('powerSupplyVoltage', e.detail.value)}
			on:change={(e) => handleConfigChange('powerSupplyVoltage', e.detail.value)}
		/>
		...
		<SettingsFormField
			...
			{disabled}
			category="led"
			settingKey="power_supply_current"
			...
			on:input={(e) => handleInput('powerSupplyCurrent', e.detail.value)}
			on:change={(e) => handleConfigChange('powerSupplyCurrent', e.detail.value)}
		/>
	</div>
	...
	<div class="config-section">
		...
		<SettingsFormField
			...
			on:change={(e) => handleConfigChange('colorProfile', e.detail.value)}
		/>
		...
		<SettingsFormField
			...
			on:change={(e) => handleConfigChange('performanceMode', e.detail.value)}
		/>
		...
		<SettingsFormField
			...
			on:input={(e) => handleInput('gamma', e.detail.value)}
			on:change={(e) => handleConfigChange('gamma', e.detail.value)}
		/>
		...
		<SettingsFormField
			...
			on:input={(e) => handleInput('colorTemp', e.detail.value)}
			on:change={(e) => handleConfigChange('colorTemp', e.detail.value)}
		/>
		...
		<SettingsFormField
			...
			on:input={(e) => handleInput('updateRate', e.detail.value)}
			on:change={(e) => handleConfigChange('updateRate', e.detail.value)}
		/>
		...
		<SettingsFormField
			...
			on:input={(e) => handleInput('maxPowerWatts', e.detail.value)}
			on:change={(e) => handleConfigChange('maxPowerWatts', e.detail.value)}
		/>
		...
		<SettingsFormField
			...
			{disabled}
			category="led"
			settingKey="max_temperature_celsius"
			...
			on:input={(e) => handleInput('maxTemp', e.detail.value)}
			on:change={(e) => handleConfigChange('maxTemp', e.detail.value)}
		/>
		...
		<SettingsFormField
			...
			on:change={(e) => handleConfigChange('dither', e.detail.value)}
		/>
		...
		<SettingsFormField
			...
			{disabled}
			category="led"
			settingKey="power_limiting_enabled"
			...
			on:change={(e) => handleConfigChange('powerLimiting', e.detail.value)}
		/>
		...
		<SettingsFormField
			...
			{disabled}
			category="led"
			settingKey="thermal_protection_enabled"
			...
			on:change={(e) => handleConfigChange('thermalProtection', e.detail.value)}
		/>
	</div>
...
<style>
	...
	/* Use global selectors to style SettingsFormField internals */
	:global(.form-field) {
		margin-bottom: 1rem;
	}
