    ...
    SCHEMA = {
        'piano': {
            ...
            'properties': {
                ...
                # Extended piano configuration
                'size': {'type': 'string'},
                'keys': {'type': 'number', 'minimum': 0, 'maximum': 128},
                'octaves': {'type': 'number', 'minimum': 0, 'maximum': 10},
                'start_note': {'type': 'string'},
                'end_note': {'type': 'string'},
                'key_mapping_mode': {'type': 'string'},
                'key_mapping': {'type': 'object'}
            }
        },
        ...
        'led': {
            ...
            'properties': {
                ...
                'led_type': {'type': 'string', 'enum': ['WS2812B', 'WS2811', 'WS2813', 'WS2815', 'APA102', 'SK6812']},
